          ...
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid '>
            <div className='grid grid-cols-12 md:text-start text-center '>
              <div className='lg:col-span-7 col-span-12 lg:text-start text-center md:min-w-[558px] md:min-h-[375px] md:top-[225px] md:left-[291px] mb-4'>
                ...
                <p className=' font-normal text-xl leading-8 text-[#050202] opacity-[70%] py-4'>Identifying gaps is a crucial step in ensuring security in any <br /> system or process. These gaps can range from technical <br /> vulnerabilities to gaps in policies and procedures.</p>
